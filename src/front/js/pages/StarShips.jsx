...
export const StarShips = () => {
    ...
    return (
        <div className="container mt-4">
            <h1 className="custom-h1 text-center mb-4 text-neon"><strong>Starships</strong></h1>
                ...
                {store.starships.map((item) => (
                    <div key={item.uid} className="col-12 col-md-6 col-lg-4 mb-4 d-flex justify-content-center">
                        <div className="card custom-card">
                            <img
                                src={`https://raw.githubusercontent.com/tbone849/star-wars-guide/refs/heads/master/build/assets/img/starships/${item.uid}.jpg`}
